    ...
    >
      ...
      <div className="bg-primary flex aspect-[59/29] w-full max-w-[590px] flex-col items-center justify-center rounded-[1.25rem]">
        ...
        <button
          ...
          className="body1 relative mb-6 flex aspect-[50/5.2] w-full max-w-[500px] items-center justify-center rounded-[0.375rem] bg-[#fff] text-[1.125rem]"
        >
          <Image
            className="absolute left-4 h-[1.125rem] w-[1.125rem]"
  ...
  return (
    ...
    >
      ...
      <div className="bg-primary flex aspect-[35/25.6] w-full max-w-[350px] flex-col items-center justify-center rounded-[1.25rem]">
        ...
        <button
          onClick={googleLoginButton}
          className="body1 relative mb-6 flex aspect-[30/4.5] w-full max-w-[300px] items-center justify-center rounded-[0.375rem] bg-[#fff]"
        >
          <Image
            className="absolute left-4 h-[1.125rem] w-[1.125rem]"
            src="/icons/google.svg"
